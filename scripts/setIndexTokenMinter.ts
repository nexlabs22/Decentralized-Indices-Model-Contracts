...
import { sepoliaAnfiFactoryAddress, sepoliaAnfiIndexTokenAddress } from "../contractAddresses";
...
async function main() {
    ...
    const cotract:any = new ethers.Contract(
        sepoliaAnfiIndexTokenAddress as string, //factory goerli
