...
contract ForkTest is Test {
    ...
    function testSwap() public {
        ...
        console.log(swapRouter.exactInputSingle(params));
        console.log(dai.balanceOf(address(this)));
        console.log(weth.balanceOf(address(this)));

        uint amountOut = quoter.quoteExactInputSingle(DAI, WETH9, 3000, dai.balanceOf(address(this)), 0);
        ...
        console.log(swapRouter.exactInputSingle(params2));
        console.log(dai.balanceOf(address(this)));
        console.log(weth.balanceOf(address(this)));
    }
}