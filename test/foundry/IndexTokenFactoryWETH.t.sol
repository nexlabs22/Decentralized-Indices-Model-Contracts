...
contract CounterTest is Test, ContractDeployer {
    ...
    function testOracleList() public {
        ...
        assertEq(factory.oracleList(4), address(weth));
        // token current list
        ...
        assertEq(factory.currentList(4), address(weth));
        // token shares
        ...
        assertEq(factory.tokenOracleMarketShare(address(weth)), 20e18);
        ...
        assertEq(factory.tokenSwapVersion(address(weth)), 3);
