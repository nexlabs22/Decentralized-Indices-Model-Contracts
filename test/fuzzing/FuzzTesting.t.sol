...
contract FuzzCounterTest is Test {
    ...
    function testFuzz_MintOnlyMinter() public {
    ...
    function testFuzz_MintWhenNotPaused() public {
        indexToken.pause();
    ...
    function testFuzz_MintExceedSupply() public {
        vm.startPrank(minter);
    ...
    function testFuzz_MintToRestricted() public {
    ...
    function testFuzz_MintMsgRestricted() public {
    ...
    function testFuzz_BurnOnlyMinter() public {
        vm.expectRevert("IndexToken: caller is not the minter");
        indexToken.burn(address(this), 1000e18);
    }

    function testFuzz_BurnWhenNotPaused() public {
        indexToken.pause();
        vm.startPrank(minter);
        vm.expectRevert("Pausable: paused");
        indexToken.burn(address(this), 1000e18);
    ...
    function testFuzz_BurnFromIsRestricted() public {
        indexToken.toggleRestriction(address(this));
        vm.startPrank(minter);
    ...
    function testFuzz_BurnMsgIsRestricted() public {
        indexToken.toggleRestriction(minter);
        vm.startPrank(minter);
        vm.expectRevert("msg.sender is restricted");
        indexToken.burn(address(this), 1000e18);
    ...
    function testFuzz_MintForFeeReceiver() public {
    ...
    function testFuzz_MintForFeeReceiverOneDay() public {
        //mint 1000 index token        
        vm.startPrank(minter);
        indexToken.mint(address(this), 1000e18);
        assertEq(indexToken.balanceOf(address(this)), 1000e18);
    ...
    function testFuzz_MintForFeeReceiverTenDays() public {
        //mint 1000 index token        
        vm.startPrank(minter);
        indexToken.mint(address(this), 1000e18);
        assertEq(indexToken.balanceOf(address(this)), 1000e18);
